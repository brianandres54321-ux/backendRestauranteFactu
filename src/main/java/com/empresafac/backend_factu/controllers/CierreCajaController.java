...
import com.empresafac.backend_factu.dto_temp.request.RegistrarBaseCajaRequest;
...
public class CierreCajaController {
     ...
     * Registra (o actualiza, mientras no esté cerrado) la base de caja del día.
     */
    @PreAuthorize("hasRole('ADMIN') or hasRole('CAJERO')")
    @PutMapping("/base")
    public ResponseEntity<CierreCajaResponse> registrarBase(
            @PathVariable Long empresaId,
            @RequestBody RegistrarBaseCajaRequest req) {
        ...
        return ResponseEntity.ok(
                cierreService.registrarBase(empresaId, usuarioId, fecha, req.getBaseInicial()));
    }
